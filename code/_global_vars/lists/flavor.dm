...
GLOBAL_LIST_INIT(music_tracks, list(
	...
	"Babes of the 80s" = /music_track/babes,
	...
	"Nowhere to Run" = /music_track/nowhere,
	"Phoron will make us Rich" = /music_track/pwmur,
	"Radioactive" = /music_track/radioactive,
	"Runner" = /music_track/runner,
	"Radiation Curring" = /music_track/radiation,
	"Fleet Party Theme" = /music_track/one_loop,
	"Funnel of Love" = /music_track/funnel,
	"Salute John" = /music_track/salutjohn,
	"Space Oddity" = /music_track/space_oddity,
	"Space Song" = /music_track/space,
	"See You Tomorrow" = /music_track/see,
	"Scratch" = /music_track/level3_mod,
	"Sweet Jane" = /music_track/sweet,
